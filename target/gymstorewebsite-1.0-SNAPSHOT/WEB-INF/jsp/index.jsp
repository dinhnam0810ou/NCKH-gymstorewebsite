...
<main>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12">
                        ...
                        <div class="about-img ">
                            ...
                            <img src="<c:url value="/images/about.png"/>" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12">
        ...
        <section class="services-area pt-100 pb-150 section-bg" data-background="  <c:url value="/images/section_bg01.png"/>">
            <!--? Want To work -->
                ...
                <div class="row align-items-center">
                    <div class="col-lg-5 col-md-11 col-sm-11">
                        ...
                        <div class="about-img2">
                            ...
                            <img src="<c:url value="/images/about2.png"/>" alt="">
                            <!-- Shape -->
                            <div class="shape-qutaion d-none d-sm-block">
                                
                                <img src="<c:url value="/images/qutaion.png"/>" alt="">
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="box snake mb-30">
                            <div class="gallery-img big-img" style="background-image: url(<c:url value="/images/gallery1.png"/>);"></div>
                            <div class="overlay">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="box snake mb-30">
                                    <div class="gallery-img small-img" style="background-image: url(<c:url value="/images/gallery2.png"/>);"></div>
                                    <div class="overlay">
                                        <div class="overlay-content">
                                            <a href="gallery.html"><i class="ti-arrow-top-right"></i></a>
                                            <h3>Best fitness gallery</h3>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="box snake mb-30">
                                    <div class="gallery-img small-img" style="background-image: url(<c:url value="/images/gallery3.png"/>);"></div>
                                    <div class="overlay">
                                        <div class="overlay-content">
                                            <a href="gallery.html"><i class="ti-arrow-top-right"></i></a>
                                            <h3>Best fitness gallery</h3>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="box snake mb-30">
                                    <div class="gallery-img small-img" style="background-image: url(<c:url value="/images/gallery4.png"/>);"></div>
                                    <div class="overlay">
                                        <div class="overlay-content">
                                            <a href="gallery.html"><i class="ti-arrow-top-right"></i></a>
                                            <h3>Best fitness gallery</h3>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="box snake mb-30">
                                    <div class="gallery-img small-img" style="background-image: url(<c:url value="/images/gallery5.png"/>);"></div>
                                    <div class="overlay">
                                        <div class="overlay-content">
                                            <a href="gallery.html"><i class="ti-arrow-top-right"></i></a>
                                            <h3>Best fitness gallery</h3>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                ...
                                <img src="<c:url value="/images/team1.png"/>" alt="">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="<c:url value="/images/team2.png"/>" alt="">
                                <div class="team-caption">
                                    <span>Creative derector</span>
                                    <h3><a href="#">Jhon Sunsaev</a></h3>
                                    <!-- Blog Social -->
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="<c:url value="/images/team3.png"/>" alt="">
                                <div class="team-caption">
                                    <span>Creative derector</span>
                                    <h3><a href="#">Jhon Sunsaev</a></h3>
                                    <!-- Blog Social -->
        ...
        <!-- Team Ara End -->
        <!--? Want To work -->
        <section class="wantToWork-area w-padding section-bg" data-background="<c:url value="/images/section_bg02.png"/>">
            <div class="container">
        ...
        <section class="contact-form-main">
            ...
            <div class="from-left d-none d-lg-block">
                ...
                <img src="<c:url value="/images/contact_form.png"/>" alt="">
            </div>
        </section>
        <!-- Contact form End -->
        <!--? Blog Area Start -->
                ...
                <div class="row">
                        ...
                        <div class="home-blog-single mb-30">
                            <div class="blog-img-cap">
                                <div class="blog-img">
                                    ...
                                    <img src="<c:url value="/images/blog1.png"/>" alt="">
                                    <!-- Blog date -->
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="home-blog-single mb-30">
                            <div class="blog-img-cap">
                                <div class="blog-img">
                                    <img src="<c:url value="/images/blog2.png"/>" alt="">
                                    <!-- Blog date -->
                                    <div class="blog-date text-center">
                                        <span>24</span>
                                        <p>Now</p>
