...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
 ...
 <footer>
        ...
        <div class="footer-area section-bg" data-background="<c:url value="/images/section_bg03.png"/>">
            <div class="container">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-5 col-sm-6">
                            <div class="single-footer-caption mb-50">
                                ...
                                <div class="footer-logo">
                                    ...
                                    <a href="index.html"><img src="<c:url value="/images/logo2_footer.png"/>" alt=""></a>
                                </div>
                                <div class="footer-tittle">
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <script src="<c:url value="/js/hover-direction-snake.min.js"/>"></script>
